...
class EmailRedefinicaoSenha extends Email {
  constructor (usuario, token) {
    ...
    this.text = `Olá! Você pediu para redefinir a sua senha. Use o Token a seguir para trocar a sua senha: ${token}`
    this.html = `<h1>Olá!</h1> Você pediu para redefinir a sua senha. Use o Token a seguir para trocar a sua senha: ${token}`
  }
}
